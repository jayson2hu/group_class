...
| 阶段 | 专家 | 场景 | 输出 | 状态 |
|---|---|---|---|---|
| X1 | E1 家长转化体验专家 | R1/R2 | 家长报名与候补体验报告 | ⬜ 待开始 |
| X2 | E2 教务运营效率专家 | R3 | 运营后台效率体验报告 | ⬜ 待开始 |
| X3 | E3 课程供给专家 | R4 | 老师建课与模板体验报告 | ⬜ 待开始 |
| X4 | E4 平台治理专家 | R5 | 审核治理体验报告 | ⬜ 待开始 |
| X5 | E5 业务经营专家 | R6 | 经营指标与看板体验报告 | ⬜ 待开始 |
| X6 | E6 移动端专家 | S1-S4 | 移动端与压力体验报告 | ⬜ 待开始 |
| X7 | 产品负责人汇总 | 全部报告 | 合并问题池和优先级排序 | ⬜ 待开始 |
...
| X6 | 移动端体验报告 | ⬜ 待开始 | - | - |
| X7 | 问题池合并和优先级排序 | ⬜ 待开始 | - | - |
| K1 | 前台课程卡片决策信息增强 | ⬜ 待专家确认 | - | - |
| K2 | 报名成功页后续预期增强 | ⬜ 待专家确认 | - | - |
| K3 | 候补成功预期增强 | ⬜ 待专家确认 | - | - |
| K4 | 报名列表状态筛选和待跟进视图 | ⬜ 待专家确认 | - | - |
| K5 | 发布前课程完整性校验 | ⬜ 待专家确认 | - | - |

...
def public_list_classes(
    ...
    state = get_state()
    viewer_scope = "backoffice" if set(actor.actor_roles).intersection({"CLASS_ADMIN", "SUPER_ADMIN", "INITIATOR"}) else "user"
    if actor.actor_id == "u_anonymous":
